...
def _kmv_lump_scheme(ref_el, degree):
    ...
    if degree == 1:
        ...
        if sd == 2:
            ...
            x = list(ref_el.vertices) #0,1,2,3
            x.extend(
                [
                    (0, 0.685789657581967, 0.314210342418033),  #4
                    (0, 0.314210342418033, 0.685789657581967),  #5
                    (0.314210342418033, 0, 0.685789657581967),  #6
                    (0.685789657581967, 0, 0.314210342418033),  #7
                    (0.685789657581967, 0.314210342418033, 0.0),#8
                    (0.314210342418033, 0.685789657581967, 0.0),#9
                    (0, 0, 0.685789657581967),                  #10
                    (0, 0, 0.314210342418033),                  #11
                    (0, 0.314210342418033, 0.0),                #12
                    (0, 0.685789657581967, 0.0),                #13
                    (0.314210342418033, 0, 0.0),                #14
                    (0.685789657581967, 0, 0.0),                #15
                ]
            )  # 12 points on edges of facets (0-->1-->2)

            x.extend(
                [
                    (0.21548220313557542, 0.5690355937288492, 0.21548220313557542), #16
                    (0.21548220313557542, 0.21548220313557542, 0.5690355937288492), #17
                    (0.5690355937288492, 0.21548220313557542, 0.21548220313557542), #18
                    (0.0, 0.5690355937288492, 0.21548220313557542),                 #19
                    (0.0, 0.21548220313557542, 0.5690355937288492),                 #20
                    (0.0, 0.21548220313557542, 0.21548220313557542),                #21
                    (0.5690355937288492, 0.0, 0.21548220313557542),                 #22
                    (0.21548220313557542, 0.0, 0.5690355937288492),                 #23
                    (0.21548220313557542, 0.0, 0.21548220313557542),                #24
                    (0.5690355937288492, 0.21548220313557542, 0.0),                 #25
                    (0.21548220313557542, 0.5690355937288492, 0.0),                 #26
                    (0.21548220313557542, 0.21548220313557542, 0.0),                #27
                ]
        ...
        if sd == 2:
            ...
            # 4 vertice points
            x = list(ref_el.vertices)
            # 12 points on facets (list 2)
            x.extend(
                [
                    (0.1724919407749086, 0, 0), 
                    (0.1724919407749086, 0, 0.8275080592250914), 
                    (0.1724919407749086, 0.8275080592250914, 0), 
                    (0, 0.1724919407749086, 0), 
                    (0, 0.1724919407749086, 0.8275080592250914), 
                    (0, 0, 0.1724919407749086), 
                    (0, 0, 0.8275080592250914), 
                    (0, 0.8275080592250914, 0.1724919407749086), 
                    (0, 0.8275080592250914, 0), 
                    (0.8275080592250914, 0.1724919407749086, 0), 
                    (0.8275080592250914, 0, 0.1724919407749086), 
                    (0.8275080592250914, 0, 0),
                ]
            )
            # 6 points (list 3)
            x.extend(
            ...
            x.extend(
                [
                    (0.1474177969013686, 0.1474177969013686, 0), 
                    (0.1474177969013686, 0.1474177969013686, 0.7051644061972628), 
                    (0.1474177969013686, 0, 0.1474177969013686), 
                    (0.1474177969013686, 0, 0.7051644061972628), 
                    (0.1474177969013686, 0.7051644061972628, 0.1474177969013686), 
                    (0.1474177969013686, 0.7051644061972628, 0), 
                    (0, 0.1474177969013686, 0.1474177969013686), 
                    (0, 0.1474177969013686, 0.7051644061972628), 
                    (0, 0.7051644061972628, 0.1474177969013686), 
                    (0.7051644061972628, 0.1474177969013686, 0.1474177969013686), 
                    (0.7051644061972628, 0.1474177969013686, 0), 
                    (0.7051644061972628, 0, 0.1474177969013686),
                ]
            )
            # 12 points (list 5)
            x.extend(
                [
                    (0.4540395272271067, 0.4540395272271067, 0), 
                    (0.4540395272271067, 0.4540395272271067, 0.09192094554578656), 
                    (0.4540395272271067, 0, 0.4540395272271067), 
                    (0.4540395272271067, 0, 0.09192094554578656), 
                    (0.4540395272271067, 0.09192094554578656, 0.4540395272271067), 
                    (0.4540395272271067, 0.09192094554578656, 0), 
                    (0, 0.4540395272271067, 0.4540395272271067), 
                    (0, 0.4540395272271067, 0.09192094554578656), 
                    (0, 0.09192094554578656, 0.4540395272271067), 
                    (0.09192094554578656, 0.4540395272271067, 0.4540395272271067), 
                    (0.09192094554578656, 0.4540395272271067, 0), 
                    (0.09192094554578656, 0, 0.4540395272271067),
                ]
            )
            # 4 points (list 6)
            x.extend(
            ...
            x.extend(
                [
                    (0.1282209316290979, 0.1282209316290979, 0.1282209316290979), 
                    (0.1282209316290979, 0.1282209316290979, 0.6153372051127064), 
                    (0.1282209316290979, 0.6153372051127064, 0.1282209316290979), 
                    (0.6153372051127064, 0.1282209316290979, 0.1282209316290979),
                ]
            )
            # 6 points (list 8)
            x.extend(
                [
                    (0.08742182088664353, 0.08742182088664353, 0.4125781791133565), 
                    (0.08742182088664353, 0.4125781791133565, 0.08742182088664353), 
                    (0.08742182088664353, 0.4125781791133565, 0.4125781791133565), 
                    (0.4125781791133565, 0.08742182088664353, 0.08742182088664353), 
                    (0.4125781791133565, 0.08742182088664353, 0.4125781791133565), 
                    (0.4125781791133565, 0.4125781791133565, 0.08742182088664353),
                ]
            )
            # 4 points (list 9)
            x.extend(
                [
                    (0.3124061452070811, 0.3124061452070811, 0.3124061452070811), 
                    (0.3124061452070811, 0.3124061452070811, 0.0627815643787567), 
                    (0.3124061452070811, 0.0627815643787567, 0.3124061452070811), 
                    (0.0627815643787567, 0.3124061452070811, 0.3124061452070811),
                ]
            )
            ...
            w = arange(65, dtype=float64)
            w[0:4]   = 0.0001216042545112321
            w[4:16]  = 0.0004704124198744411
            w[16:22] = 0.0001767065925083475
            w[22:34] = 0.001974748586596177
            w[34:46] = 0.001192465311769701 
            w[46:50] = 0.001044697597634123
            w[50:54] = 0.008841425190569096
